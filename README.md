...
- [Collaborative Deep Learning for Recommender Systems](https://arxiv.org/pdf/1409.2944.pdf)
    - CDL
- [PU Learning for Matrix Completion](http://proceedings.mlr.press/v37/hsiehb15.pdf)
    - ShiftMC
- [Relational Stacked Denoising Autoencoder for Tag Recommendation](https://www.researchgate.net/publication/280082635_Relational_Stacked_Denoising_Autoencoder_for_Tag_Recommendation)
    - RSDAE
- [Reversed CF: A fast collaborative filtering algorithm using a k-nearest neighbor graph](https://tarjomefa.com/wp-content/uploads/2015/10/4166-engilish.pdf)
    - RCF
...
- [Collaborative Recurrent Autoencoder: Recommend while Learning to Fill in the Blanks](https://arxiv.org/pdf/1611.00454.pdf)
    - CRAE
...
- [Hybrid Recommender System based on Autoencoders](https://arxiv.org/pdf/1606.07659.pdf)
    - CFN
- [Mixture-Rank Matrix Approximation for Collaborative Filtering](https://pdfs.semanticscholar.org/dcc1/f5093fdc793c55ce0988dca06b861e3e1ff2.pdf)
    - MRMA
...
- [RecVAE: a New Variational Autoencoder for Top-N Recommendations with Implicit Feedback](https://arxiv.org/pdf/1912.11160.pdf)
    - RecVAE
- [Enhancing VAEs for Collaborative Filtering: Flexible Priors & Gating Mechanisms](https://arxiv.org/ftp/arxiv/papers/1911/1911.00936.pdf)
    - H+Vamp Gated
- [RecWalk: Nearly Uncoupled Random Walks for Top-N Recommendation](https://www.nikolako.net/papers/ACM_WSDM2019_RecWalk.pdf)
    - RecWalk
- [Semi-supervised Learning with Graph Learning-Convolutional Networks](https://openaccess.thecvf.com/content_CVPR_2019/papers/Jiang_Semi-Supervised_Learning_With_Graph_Learning-Convolutional_Networks_CVPR_2019_paper.pdf)
    - GLCN
- [Session-based Social Recommendation via Dynamic Graph Attention Networks](http://www.cs.toronto.edu/~lcharlin/papers/fp4571-songA.pdf)
    - DGRec
...
- [ALBERT: A Lite BERT for Self-supervised Learning of Language Representations](https://arxiv.org/pdf/1909.11942.pdf)
    - ALBERT
- [Network of Evolvable Neural Units: Evolving to Learn at a Synaptic Level](https://arxiv.org/pdf/1912.07589.pdf)
    - ENU
